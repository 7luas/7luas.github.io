...
function updateLayoutElements(){
	...
	// ROOT
	// By default, fill screen (looks good for mobile - ie < screenPropCutoffMobile -  and desktop - i.e. > screenPropCutoffDesktop)
	root.heightRel = 1;
	root.widthRel = 1;
	var fixedWee=0;
	var fixedHee=0;
	introText.style.width="70%";
	// Below screenPropCutoffMiddle, force mobile
	...
	// Above screenPropCutoffMiddle, force desktop
...
function mainLoop(timestamp) { 												// The main loop (calls itself at end)
	...
	if(gameState=="intro"){
		...
		//gameState="beforeFirstPassenger"; // skips intro, for testing
  	}
